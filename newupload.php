 <?php
                           ...
                           $CI=$_POST['submit'];
                            ...
                            $str = "Delete from problems where Problem_Code='".$CI."'";
                             $sq=$conn->query($str); 
                            $conn->close();
?>
<!DOCYTPE html>
<html>
    ...
    <body>
        ...
        <div class="details row container">
            ...
            <form method="post" enctype="multipart/form-data" action="upload_check2.php" name="upload_form">
                <?php
